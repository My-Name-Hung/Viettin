  ...
  _createClass(JSCGrid, [{
    ...
    value: function renderGrid() {
      ...
      if (updateExisting) {
        ...
        this.instance && this.instance.destroy();
        var containerElement = this.container;
        JSC.Grid(containerElement, options).then(function (grid) {
...
export { JSCGrid, JSCLabel, JSCharting, JSCharting as default };
//# sourceMappingURL=jscharting-react.es.js.map
