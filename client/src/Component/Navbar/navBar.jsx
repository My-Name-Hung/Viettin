...
function navBar() {
  ...
  const dropdownItems = [
    ...
    { label: "Định giá tự động", path: "/dinh-gia-tu-dong" },
    { label: "Đào tạo thẩm định giá", path: "/dao-tao-tham-dinh-gia" },
    ...
    <Navbar className="shadow-lg" isBordered onMenuOpenChange={setIsMenuOpen}>
      <NavbarContent justify="center">
        ...
        <NavbarBrand>
          ...
          <p className=" border-r-[1px] pr-1 pt-[14px] border-t-0 border-l-0 border-b-0 border-gray-400 h-12 hover:cursor-pointer font-bold text-inherit text-sm text-purple-800 hover:text-red-800">
        ...
        {menuItems.slice(0, 5).map(
          (
            ...
            <NavbarItem key={index}>
              <Link
                id="NavbarItem"
                className={`pt-[1.5rem] inline-block justify-between px-1 text-sm flex-1 hover:rounded-sm hover:text-purple-900 hover:font-semibold ${
